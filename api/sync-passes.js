  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;margin:0 auto;padding:40px 20px;">
    ...
    <tr><td style="background:#1E1E1C;border-radius:16px;border:1px solid rgba(201,165,90,0.2);padding:32px;text-align:center;">
      ...
      <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
        <tr>
          <td style="border:1px solid rgba(201,165,90,0.45);border-radius:14px;padding:16px 20px;background:rgba(201,165,90,0.06);">
            <p style="font-size:10px;letter-spacing:2.5px;color:#C9A55A;margin:0 0 12px;text-align:center;">YOUR PASS IS READY</p>
            <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
              <tr>
            ...
            <p style="color:rgba(245,240,232,0.35);font-size:11px;margin:12px 0 0;text-align:center;">
              Open on your iPhone for the best experience.
            </p>
          </td>
        </tr>
      </table>
